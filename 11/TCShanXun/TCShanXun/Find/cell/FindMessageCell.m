...
@implementation FindMessageCell
...
- (void)topicMethod:(UIButton *)button {
    ...
    if (_model.if_guanzhu.intValue == 0) {
        ...
        vc.bModel = _model;
        vc.hidesBottomBarWhenPushed = YES;
        [self.viewController.view.viewController.navigationController pushViewController:vc animated:YES];
