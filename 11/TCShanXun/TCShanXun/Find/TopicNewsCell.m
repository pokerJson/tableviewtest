...
- (void)addSubviews {
    ...
    _topicLabel = [[UILabel alloc]initWithFrame:CGRectMake(15, 15, 150, 35)];
    _topicLabel.font = UIFontSys(15);
    ...
    _likeButton = [[ITButton alloc]init];
    ...
    _commentButton = [[ITButton alloc]init];
...
- (void)loadDataWithModel:(BListModel *)model {
    ...
    _topicLabel.text = [NSString dateFormat:model.posttime.integerValue formatter:@"MM-dd HH:mm"];;
    
    //[_sourceButton setTitle:[NSString stringWithFormat:@"来自:%@",model.source_site] forState:UIControlStateNormal];
    //NSLog(@"%@",model.source_site);
